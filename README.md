...
<img width="771" height="54" alt="Screenshot from 2026-05-04 15-37-13" src="https://github.com/user-attachments/assets/1a3d9378-1dab-4820-8ecf-53a976e6ac8c" />


## Instalacion de docker levantado con couchDB
Para la instacion de docker se utilizo los siguiente comandos:
```PowerShell
sudo apt update
